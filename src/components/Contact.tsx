          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">info@aboalsoud.com</p>
                  <p className="text-gray-400">support@aboalsoud.com</p>
                </div>
              </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-dark-gray p-3 rounded-full hover:bg-primary/20 transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-dark-gray border border-gray-700 rounded-lg focus:outline-none focus:border-primary text-white"
                  required
                />
              </div>
